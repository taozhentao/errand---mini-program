	...
	<view style="padding: 20rpx;">
		<view class="box" style="margin-bottom: 10rpx;">
			<uni-forms :modelValue="form" :rules="rules" ref="formRef" label-width="160rpx" label-align="right"
				...
				<view>
					<button type="primary" style="background-color: #006eff;" @click="save">保存并使用</button>
				</view>
			</uni-forms>
		</view>

		<view class="box" v-if="addressList.length">
			<view v-for="item in addressList" :key="item.id" @click="selectAddress(item)">
				<view style="padding: 10rpx 0; border-bottom: 1px solid #eee;">
