	...
	<view style="padding: 20rpx;">
		...
		<view class="box" style="margin-bottom: 10rpx;" @click="selectAddress('收货')">
			...
			<view v-if="recieveAddress.id">
				<view style="font-weight: bold; font-size: 32rpx; margin-bottom: 10rpx;">
					{{ recieveAddress.address + recieveAddress.doorNo }}</view>
				<view style="color: #888; margin-bottom: 10rpx;">
		...
		<view class="box">
			...
			<view>
				<button type="primary" @click="addOrder" style="background-color: #006eff;">提交订单</button>
			</view>
		</view>
	</view>
</template>
	...
	export default {
		...
		methods: {
			selectAddress(addressType) {
				uni.navigateTo({
					url: '/pages/addres/addres?addressType=' + addressType
				})
			},
